...
(() => {
  ...
  // src/utils/createSwiperInstance.ts
  function createSwiperInstance(element, swiperOptions) {
  ...
  window.Webflow.push(async () => {
    ...
    components.forEach((component) => {
      ...
      if (!element)
        return;
      const tabLinksList = component.querySelector('[swiper="bullet-list"]');
      const tabLinksValues = Array.from(
        component.querySelectorAll('[swiper-pagination-element="value"]')
      ).map((value) => value.textContent);
      const tabLinkClass = component.querySelector('[swiper="bullet-class"]')?.className || "";
      const options = {
...
//# sourceMappingURL=productsSlider.js.map
